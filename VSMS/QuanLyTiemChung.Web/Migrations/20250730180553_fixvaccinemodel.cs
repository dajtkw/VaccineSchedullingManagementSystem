...
{
    /// <inheritdoc />
    public partial class fixvaccinemodel : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VaccinationSites", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_VaccinationSites_VaccinationSiteId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DoseNumber = table.Column<int>(type: "int", nullable: false),
                    IntervalFromPreviousDoseInDays = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthOfficialId = table.Column<int>(type: "int", nullable: false),
                    ActualVaccinationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    VaccineLotNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    NotesAfterShot = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VaccinationRecords_AspNetUsers_HealthOfficialId",
                        column: x => x.HealthOfficialId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_VaccinationSiteId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VaccinationRecords_HealthOfficialId",
                table: "VaccinationRecords",
                column: "HealthOfficialId");
